...
func (c *postServiceClient) GetPostsByIds(ctx context.Context, in *GetPostsByIdsRequest, opts ...grpc.CallOption) (*GetPostsByIdsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/post_api.PostService/GetPostsByIds", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *postServiceClient) UpsertPost(ctx context.Context, in *UpsertPostRequest, opts ...grpc.CallOption) (*UpsertPostResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/post_api.PostService/UpsertPost", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _PostService_GetPostsByIds_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/post_api.PostService/GetPostsByIds",
	}
...
func _PostService_UpsertPost_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/post_api.PostService/UpsertPost",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
